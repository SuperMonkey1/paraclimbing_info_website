          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="w-full md:w-auto mb-4 md:mb-0">
              <div className="inline-flex rounded-md shadow-sm" role="group">
                ...
                >
                  {t('activitiesPage.filters.international')}
                </button>
                <button 
                  type="button" 
                  className={`px-4 py-2 text-sm font-medium border-t border-b ${
      ...
      <section className="section bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-dark mb-4">{t('activitiesPage.regularActivities.title')}</h2>
            <p className="text-gray-700 max-w-3xl mx-auto">
              {t('activitiesPage.regularActivities.description')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-8 max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-6" id="monthly-training">
                <h3 className="text-xl font-bold text-dark mb-3">{t('activitiesPage.regularActivities.monthlyTraining.title')}</h3>
                <div className="mb-4 text-gray-600">
                  <div className="flex items-center mb-1">
                    ...
                    <span>{t('activitiesPage.regularActivities.monthlyTraining.locationPrefix')}</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="h-5 w-5 mr-2 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{t('activitiesPage.regularActivities.monthlyTraining.timePrefix')}</span>
                  </div>
                </div>
                <p className="text-gray-700 mb-4">
                  {t('activitiesPage.regularActivities.monthlyTraining.description')}
                </p>
                <div className="flex justify-between items-center">
                  ...
                  >
                    ...
                    {t('activitiesPage.regularActivities.monthlyTraining.contactUs')}
                  </a>
                  <div className="text-gray-600 text-sm">
                    <span className="block">{t('activitiesPage.regularActivities.monthlyTraining.socialMediaCheck')}</span>
                    <span className="block">{t('activitiesPage.regularActivities.monthlyTraining.newsletterSubscribe')}</span>
                  </div>
                </div>
              </div>
            </div>
